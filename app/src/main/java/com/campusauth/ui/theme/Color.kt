package com.campusauth.ui.theme

import androidx.compose.ui.graphics.Color

// Fallback colors for devices without dynamic color (pre-Android 12)
val GreenConnected = Color(0xFF6CB83F)
val OrangeCaptive  = Color(0xFFFFA500)
val RedError       = Color(0xFFE54C52)
val GrayUnknown    = Color(0xFF808080)
val BluePrimary    = Color(0xFF007ED4)
